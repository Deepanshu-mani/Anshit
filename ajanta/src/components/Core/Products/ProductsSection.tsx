                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                  {filteredProducts.map((product) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        {/* Product name and color section */}
                        <div className="flex justify-between items-start gap-2">
                          {/* Full width for product name on mobile */}
                          <h3 className="text-lg font-medium text-gray-900 sm:line-clamp-1">{product.name}</h3>

                          {/* Only show color badge on large screens (lg and up) */}
                          {product.colour && (
                            <Badge
                              variant="outline"
                              className="bg-gray-50 text-gray-700 whitespace-nowrap text-xs hidden lg:inline-flex"
                            >
                              {product.colour}
                            </Badge>
                          )}
                        ...
                        {/* Show color as text on small screens */}
                        <p className="text-gray-500 text-sm mt-0.5 lg:hidden">Color: {product.colour}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
            ...
            >
              ...
              <div className="relative w-full md:w-1/2 h-[40vh] md:h-auto bg-gray-50">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      src={selectedProductData.images[activeImageIndex] || "/placeholder.svg" || "/placeholder.svg"}
