  ...
  return (
    <div className="relative mt-14">
      ...
      <Image
        ...
        className="w-full h-[30vh] sm:h-[40vh] md:h-[70vh] lg:h-[90vh] object-cover object-center"
        priority
      />

      {/* Text Content */}
      <div className="absolute inset-0 flex flex-col justify-center items-start sm:items-start sm:text-left px-4 sm:px-6 md:px-20 pt-10 pl-4">
        <div className="w-[80%]">
          ...
          <a
            ...
            className="bg-gray-800 text-white px-3 py-2 sm:px-5 sm:py-3 md:px-6 md:py-4 rounded-lg hover:bg-gray-700 transition inline-block text-[10px] sm:text-xs md:text-sm"
          >
